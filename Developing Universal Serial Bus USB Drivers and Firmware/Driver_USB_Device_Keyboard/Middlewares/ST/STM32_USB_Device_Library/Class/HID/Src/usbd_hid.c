...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x01,                                               /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse */  //This is another modification that has to be done for setting keyboard
      ...
      switch (req->bRequest)
      {
        ...
        case USB_REQ_GET_DESCRIPTOR:
          if ((req->wValue >> 8) == HID_REPORT_DESC)
          {
            ...
            ///TODO: Modification from the setting of the mouse
