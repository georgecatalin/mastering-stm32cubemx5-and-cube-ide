...
int main(void)
{
  ...
  keyboard_buffer[0] = 1; //report_id
  keyboard_buffer[1] = 0; //modifier
  keyboard_buffer[2] = 0; //oem
  keyboard_buffer[3] = 0; //keycode data  //This will be read when the "key" is pressed
  ...
  while (1)
  {
	  ...
	  {
		  //TODO
		  keyboard_buffer[3] =0x4E; //PgDwn press  >> https://gist.github.com/MightyPork/6da26e382a7ad91b5496ee55fdc73db2
		  ...
		  //TODO
		  keyboard_buffer[3] = 0; //PgDwn release
		  USBD_HID_SendReport(&hUsbDeviceFS,keyboard_buffer,8);
		  HAL_Delay(80);
	  }
  }
